...
ui <- fluidPage(
    ...
    title = shiny::span(img(src = "DNR_logo.jpg", height = 100), 
                     "WIDNR Deer Processor Aging Data")),
        # Code below creates the welcome page and text that goes on it
    navbarPage(" ", 
               id = 'tabs', 
        tabPanel(("Welcome"), ## Welcome Page 
                 h2("Welcome to the WIDNR app for aging data entry. This process involves 6 steps. Be sure to follow them",strong("exactly"),"!"),
                 ...
                 h5("Questions About App", strong("Beth Wojcik"), 
                    "(she/her/hers)", strong("beth.wojcik@wisconsin.gov","(608) 221-6367")),
